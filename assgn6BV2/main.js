...
function displayItemsInCart(){
    for (i = 1; i < 5; i++ ){
        ...
        console.log("i",i)
        if (x == true){
            console.log("displayItemsInCart is running x is true")
            if (i == "1") {
                displayValue+=1;
                console.log("displayValue in i", displayValue)
            }
            else if (i== "2") {
                displayValue+=3;
            }
